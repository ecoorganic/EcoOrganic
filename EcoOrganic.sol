...
pragma solidity ^0.8.0;
contract ENEDEX is ERC20, Ownable {
    ...
    constructor() ERC20("ECOORGANIC", "ECO") {
        _mint(msg.sender, 1300000000*10**decimals());
        _mint(address(this), 1700000000*10**decimals());
        startAirdrop(block.number,999999999,1500*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 9;
    }
